          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                ...
                <p className="text-gray-600 text-sm">Download Reels in full HD quality</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                ...
                <h3 className="font-bold text-lg mb-2">Fast Download</h3>
                <p className="text-gray-600 text-sm">Save Reels in seconds</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                ...
                <p className="text-gray-600 text-sm">Clean videos without logos</p>
              </div>
            </div>
          </div>
        </section>
